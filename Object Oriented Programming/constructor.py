...
# Create a constructor in python - __init__ is a keyword which are used to create a constructor in python.
    ...
    def add(self):
        ...
        return result
obj1 = Constructor(10,20) # as object is created, value defined in the argument will be auto-assigned with the parameter deifined in the constructor.
obj2 = Constructor(20,30)
obj1.greet()
result1 = obj1.add()
print(result1)
print(obj2.add())